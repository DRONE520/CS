...
int rope()
{
	...
	float rad = 0.001, length=0.1;// Радиус шара, длина веревки.
	float x= 0.005, y = 0.005, z = 0.005;// Стороны кубика.
	...
	is << "<gravity>1</gravity>\n<visual name='visual'>\n<geometry>\n<box>\n<size>"<< x <<" "<< y <<" "<< z <<"</size>\n</box>\n</geometry>\n<material>\n<script>\n<name>Gazebo/ Grey</name><uri>file://media/materials/scripts/gazebo.material</uri>\n";
